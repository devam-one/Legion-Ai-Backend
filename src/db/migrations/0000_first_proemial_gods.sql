CREATE TYPE "public"."generation_type" AS ENUM('image', 'video', 'text');--> statement-breakpoint
...
ALTER TABLE "posts" ADD CONSTRAINT "posts_content_id_ai_generations_id_fk" FOREIGN KEY ("content_id") REFERENCES "public"."ai_generations"("id") ON DELETE cascade ON UPDATE no action;